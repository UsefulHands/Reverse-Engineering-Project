...
`);
    ...
    (function(Il2Cpp2) {
      ...
      function tryModule() {
        ...
        return Process.findModuleByName(moduleName) ?? Process.findModuleByName(fallback ?? moduleName) ?? Process.findModuleByAddress(DebugSymbol.fromName("il2cpp_init").address) ?? void 0;
      }
...
var require_index = __commonJS({
  "index.ts"(exports) {
    ...
    var originalGetExportByName = ModuleAny.getExportByName.bind(Module);
    ModuleAny.getExportByName = function(name) {
      const mapped = mapping[name] ?? name;
      return originalGetExportByName(mapped);
    };
  }
});
